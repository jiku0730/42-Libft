...
/*   Updated: 2025/07/16 16:43:00 by kei2003730       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void test_overflow(void)
{
    ...
    ASSERT_EQ(atol("9223372036854775807"), ft_atol("9223372036854775807"), "%ld");
    ASSERT_EQ(atol("-9223372036854775808"), ft_atol("-9223372036854775808"), "%ld");
    ASSERT_EQ(atol("9223372036854775808"), ft_atol("9223372036854775808"), "%ld");
}

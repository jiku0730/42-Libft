...
/*   Updated: 2025/07/16 16:43:01 by kei2003730       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void test_overflow(void)
{
    ...
    ASSERT_EQ(atoll("9223372036854775807"), ft_atoll("9223372036854775807"), "%lld");
    ASSERT_EQ(atoll("-9223372036854775808"), ft_atoll("-9223372036854775808"), "%lld");
    ASSERT_EQ(atoll("9223372036854775808"), ft_atoll("9223372036854775808"), "%lld");
}
